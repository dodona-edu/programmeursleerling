...
namespace = {'anagrams': module.anagrams}
...
# words with all-distinct letters use sorted(anagrams(word)), which is a
# deterministic list of the n! permutations; words with repeated letters use
# sorted(set(anagrams(word))), which accepts both a duplicate-producing and a
# de-duplicating solution.
cases = [
    ["sorted(anagrams(''))"],
    ["sorted(anagrams('q'))"],
    ["sorted(anagrams('ab'))"],
    ["sorted(set(anagrams('oo')))"],
    ["sorted(anagrams('cat'))"],
    ["sorted(set(anagrams('eve')))"],
    ["sorted(set(anagrams('gag')))"],
    ["sorted(anagrams('lamp'))"],
    ["sorted(anagrams('monk'))"],
    ["sorted(set(anagrams('noon')))"],
    ["sorted(set(anagrams('roar')))"],
    ["sorted(anagrams('cider'))"],
    [
        "g = anagrams('ab')",
        "first = next(g)",
        "second = next(g)",
...
# generate unit tests for the anagrams generator
